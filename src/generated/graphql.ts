...
/** The &quot;AcfImoveis&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type AcfImoveis = AcfFieldGroup & AcfFieldGroupFields & AcfImoveis_Fields & {
  __typename?: 'AcfImoveis';
  /** Área construída em metros quadrados */
  areaConstruida?: Maybe<Scalars['Float']['output']>;
  ...
  /** Número de banheiros */
  banheiros?: Maybe<Scalars['Float']['output']>;
  /** Marque as características do imóvel */
  caracteristicas?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** CEP do imóvel */
  ...
  condominio?: Maybe<Scalars['Float']['output']>;
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Adicione as fotos do imóvel */
  galeriaFotos?: Maybe<AcfMediaItemConnection>;
  /** Valor anual do IPTU */
  iptu?: Maybe<Scalars['Float']['output']>;
  /** Digite o valor do imóvel */
  preco?: Maybe<Scalars['Float']['output']>;
  /** Número de quartos */
  quartos?: Maybe<Scalars['Float']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;AcfImoveis&quot; Field Group */
  referenciaImovel?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;AcfImoveis&quot; Field Group */
  sobreOImoveil?: Maybe<Scalars['String']['output']>;
  /** Status atual do imóvel */
  statusImovel?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Número de suítes */
  suites?: Maybe<Scalars['Float']['output']>;
  /** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;AcfImoveis&quot; Field Group */
  testada?: Maybe<Scalars['Float']['output']>;
  /** Selecione o tipo de imóvel */
  tipoImovel?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Selecione o tipo de negócio */
  tipoNegocio?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Número de vagas na garagem */
  vagasGaragem?: Maybe<Scalars['Float']['output']>;
  /** Link do vídeo no YouTube (opcional) */
  videoYoutube?: Maybe<Scalars['String']['output']>;
};


/** The &quot;AcfImoveis&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type AcfImoveisGaleriaFotosArgs = {
...
/** Interface representing fields of the ACF &quot;AcfImoveis&quot; Field Group */
export type AcfImoveis_Fields = {
  /** Área construída em metros quadrados */
  areaConstruida?: Maybe<Scalars['Float']['output']>;
  /** Área total em metros quadrados */
  areaTotal?: Maybe<Scalars['Float']['output']>;
...
/** Interface representing fields of the ACF &quot;AcfImoveis&quot; Field Group */
export type AcfImoveis_FieldsGaleriaFotosArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the AcfImoveis_Fields type and the MediaItem type */
...
/** Input for the createImovel mutation. */
...
/** The payload for the createImovel mutation. */
export type CreateImovelPayload = {
  __typename?: 'CreateImovelPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Input for the deleteImovel mutation. */
export type DeleteImovelInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the Imovel to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteImovel mutation. */
export type DeleteImovelPayload = {
  __typename?: 'DeleteImovelPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type Imovel = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfAcfImoveis & {
   ...
   */
  ancestors?: Maybe<ImovelToImovelConnection>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the imoveis object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the imoveis object. */
  id: Scalars['ID']['output'];
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  imovelId: Scalars['Int']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
   ...
   */
  parent?: Maybe<ImovelToParentConnectionEdge>;
  /** The password for the imoveis object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the Imovel type and the Imovel type */
  preview?: Maybe<ImovelToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
  ...
  /** Connection between the Imovel type and the Imovel type */
  revisions?: Maybe<ImovelToRevisionConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']['output']>;
...
export type ImovelRevisionsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ImovelToRevisionConnectionWhereArgs>;
};
...
export type ImovelConnection = {
  ...
  /** A list of connected Imovel Nodes */
  nodes: Array<Imovel>;
  /** Information about pagination in a connection. */
...
export type ImovelToImovelConnection = Connection & ImovelConnection & {
  __typename?: 'ImovelToImovelConnection';
  /** Edges for the ImovelToImovelConnection connection */
  edges: Array<ImovelToImovelConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Imovel>;
  /** Information about pagination in a connection. */
  pageInfo: ImovelToImovelConnectionPageInfo;
};

/** An edge in a connection */
export type ImovelToImovelConnectionEdge = Edge & ImovelConnectionEdge & {
  __typename?: 'ImovelToImovelConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Connection between the Imovel type and the Imovel type */
export type ImovelToParentConnectionEdge = Edge & ImovelConnectionEdge & OneToOneConnection & {
  __typename?: 'ImovelToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Imovel type and the Imovel type */
export type ImovelToPreviewConnectionEdge = Edge & ImovelConnectionEdge & OneToOneConnection & {
  __typename?: 'ImovelToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Imovel;
...
/** Connection between the Imovel type and the Imovel type */
export type ImovelToRevisionConnection = Connection & ImovelConnection & {
  __typename?: 'ImovelToRevisionConnection';
  /** Edges for the ImovelToRevisionConnection connection */
  edges: Array<ImovelToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Imovel>;
  /** Information about pagination in a connection. */
  pageInfo: ImovelToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type ImovelToRevisionConnectionEdge = Edge & ImovelConnectionEdge & {
  __typename?: 'ImovelToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Imovel;
...
/** Arguments for filtering the ImovelToRevisionConnection connection */
export type ImovelToRevisionConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
export type RootMutation = {
  ...
  createImovel?: Maybe<CreateImovelPayload>;
  ...
  deleteImovel?: Maybe<DeleteImovelPayload>;
  ...
  updateImovel?: Maybe<UpdateImovelPayload>;
...
/** The root mutation */
export type RootMutationCreateImovelArgs = {
...
/** The root mutation */
export type RootMutationDeleteImovelArgs = {
  input: DeleteImovelInput;
};
...
/** The root mutation */
export type RootMutationUpdateImovelArgs = {
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the Imovel type */
  imoveis?: Maybe<RootQueryToImovelConnection>;
  /** An object of the Imovel Type. Sistema de gestão de imóveis */
  imovel?: Maybe<Imovel>;
  /**
   * A Imovel object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  imovelBy?: Maybe<Imovel>;
...
/** The root entry point into the Graph */
export type RootQueryImoveisArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToImovelConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryImovelArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<ImovelIdType>;
};


/** The root entry point into the Graph */
export type RootQueryImovelByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  imovelId?: InputMaybe<Scalars['Int']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
...
/** Connection between the RootQuery type and the Imovel type */
export type RootQueryToImovelConnection = Connection & ImovelConnection & {
  __typename?: 'RootQueryToImovelConnection';
  /** Edges for the RootQueryToImovelConnection connection */
  edges: Array<RootQueryToImovelConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Imovel>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToImovelConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToImovelConnectionEdge = Edge & ImovelConnectionEdge & {
  __typename?: 'RootQueryToImovelConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Imovel;
...
/** Arguments for filtering the RootQueryToImovelConnection connection */
export type RootQueryToImovelConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Input for the updateImovel mutation. */
...
/** The payload for the updateImovel mutation. */
export type UpdateImovelPayload = {
  __typename?: 'UpdateImovelPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  imovel?: Maybe<Imovel>;
...
export type User = Commenter & DatabaseIdentifier & Node & UniformResourceIdentifiable & WithAcfAcfImoveis & {
  ...
  imoveis?: Maybe<UserToImovelConnection>;
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean']['output'];
...
export type UserImoveisArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<UserToImovelConnectionWhereArgs>;
};
...
/** Connection between the User type and the Imovel type */
export type UserToImovelConnection = Connection & ImovelConnection & {
  __typename?: 'UserToImovelConnection';
  /** Edges for the UserToImovelConnection connection */
  edges: Array<UserToImovelConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Imovel>;
  /** Information about pagination in a connection. */
  pageInfo: UserToImovelConnectionPageInfo;
};

/** An edge in a connection */
export type UserToImovelConnectionEdge = Edge & ImovelConnectionEdge & {
  __typename?: 'UserToImovelConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Imovel;
...
/** Arguments for filtering the UserToImovelConnection connection */
export type UserToImovelConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: InputMaybe<Scalars['Int']['input']>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
/** Provides access to fields of the &quot;AcfImoveis&quot; ACF Field Group via the &quot;acfImoveis&quot; field */
export type WithAcfAcfImoveis = {
  /** Fields of the AcfImoveis ACF Field Group */
  acfImoveis?: Maybe<AcfImoveis>;
};
