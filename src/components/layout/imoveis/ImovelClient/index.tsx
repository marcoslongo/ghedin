...
export default function ImovelClient({ imovel }: { imovel: any }) {
  ...
  {/* Coluna principal: galeria e sobre o imóvel */}
  ...
  {/* Card lateral de preço e informações do imóvel */}
      ...
      <CardContent>
        ...
        <div className="flex gap-2">
          <Button
            ...
            className={`flex-1 cursor-pointer hover:bg-[#9a8167] hover:text-white ${
              favorited ? "bg-[#9a8167] text-white" : "bg-transparent"
            }`}
            onClick={() =>
              toggleFavorite({
                id: imovel.id,
